//
//  DisparityToDepth.m/Users/sjy234/Documents/work/fushion development/develop/Scanner_Metal/Scanner/MetalFushion/MetalDisparityToDepthMap.metal
//  Scanner
//
...
#import "DisparityToDepth.h"

@interface DisparityToDepth ()
...
@implementation DisparityToDepth
...
- (void)buildPipelines
{
    ...
    id<MTLFunction> kernelFunction = [library newFunctionWithName:@"disparityToDepth"];
...
- (id<MTLBuffer>)bufferWithF16PixelBuffer:(CVPixelBufferRef)f16PixelBuffer
{
    ...
    buffer = [_metalContext.device newBufferWithBytes:float16Address
                                               length:LANDSCAPE_WIDTH*LANDSCAPE_HEIGHT*2
...
- (void)compute:(CVPixelBufferRef)disparityPixelBuffer intoDepthMapBuffer:(id<MTLBuffer>) depthMapBuffer
{
    ...
    if(!inDisparityMapBuffer||!depthMapBuffer){
        return;
    }
    
    id<MTLCommandBuffer> commandBuffer = [_metalContext.commandQueue commandBuffer];
    commandBuffer.label = @"DisparityToDepthCommand";
