...
#import "PyramidDepthMap.h"

@interface PyramidDepthMap ()
...
@implementation PyramidDepthMap
...
- (void)buildPipelines
{
    ...
    id<MTLFunction> kernelFunction = [library newFunctionWithName:@"pyramidDepthMap"];
...
- (void)compute:(id<MTLBuffer>)inDepthMapBuffer intoDepthMapBuffer:(id<MTLBuffer>) outDepthMapBuffer withLevel:(uint) level
{
    ...
    commandBuffer.label = @"PyramidDepthMapCommand";
