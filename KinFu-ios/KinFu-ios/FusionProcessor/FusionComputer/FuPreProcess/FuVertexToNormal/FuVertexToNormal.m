...
@implementation FuVertexToNormal
...
- (void)buildPipelines
{
    ...
    id<MTLFunction> kernelFunction = [library newFunctionWithName:@"fuVertexToNormal"];
...
- (void)compute:(id<MTLBuffer>)inVertexMapBuffer intoNormalMapBuffer:(id<MTLBuffer>) outNormalMapBuffer withLevel:(uint) level
{
    ...
    commandBuffer.label = @"FuVertexToNormalCommand";
