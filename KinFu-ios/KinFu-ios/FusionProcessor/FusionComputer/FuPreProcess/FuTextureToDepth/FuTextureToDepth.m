...
@implementation FuTextureToDepth
...
- (void)buildPipelines
{
    ...
    id<MTLFunction> kernelFunction = [library newFunctionWithName:@"fuTextureToDepth"];
...
- (void)compute:(id<MTLTexture>) inDepthTexture intoTexture: (id<MTLBuffer>)outDepthMapBuffer with: (CameraNDC2Depth) cameraFrustum
{
    ...
    commandBuffer.label = @"FuTextureToDepthCommand";
